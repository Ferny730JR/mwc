/*
  ...
  gengetopt --input=mwc.ggo --file-name=mwc_cmdl --include-getopt --default-optional --unamed-opts --func-name=mwc_cmdline_parser --arg-struct-name=mwc_args_info
...
const char *mwc_args_info_versiontext = "";
...
static
void clear_given (struct mwc_args_info *args_info);
static
void clear_args (struct mwc_args_info *args_info);

static int
mwc_cmdline_parser_internal (int argc, char **argv, struct mwc_args_info *args_info,
                        struct mwc_cmdline_parser_params *params, const char *additional_error);
...
static
void init_args_info(struct mwc_args_info *args_info)
{


  args_info->help_help = mwc_args_info_help[0] ;
  args_info->version_help = mwc_args_info_help[1] ;
...
void
mwc_cmdline_parser_print_version (void)
{
  printf ("%s %s\n",
     (strlen(MWC_CMDLINE_PARSER_PACKAGE_NAME) ? MWC_CMDLINE_PARSER_PACKAGE_NAME : MWC_CMDLINE_PARSER_PACKAGE),
     MWC_CMDLINE_PARSER_VERSION);

  if (strlen(mwc_args_info_versiontext) > 0)
    printf("\n%s\n", mwc_args_info_versiontext);
}

static void print_help_common(void)
{
	size_t len_purpose = strlen(mwc_args_info_purpose);
	size_t len_usage = strlen(mwc_args_info_usage);

	if (len_usage > 0) {
		printf("%s\n", mwc_args_info_usage);
	}
	if (len_purpose > 0) {
		printf("%s\n", mwc_args_info_purpose);
	}
	...
	if (strlen(mwc_args_info_description) > 0) {
		printf("%s\n\n", mwc_args_info_description);
	}
}

void
mwc_cmdline_parser_print_help (void)
{
  int i = 0;
  print_help_common();
  while (mwc_args_info_help[i])
    printf("%s\n", mwc_args_info_help[i++]);
}

void
mwc_cmdline_parser_init (struct mwc_args_info *args_info)
{
...
void
mwc_cmdline_parser_params_init(struct mwc_cmdline_parser_params *params)
{
  if (params)
    { 
      params->override = 0;
...
mwc_cmdline_parser_params_create(void)
{
  struct mwc_cmdline_parser_params *params = 
    (struct mwc_cmdline_parser_params *)malloc(sizeof(struct mwc_cmdline_parser_params));
  mwc_cmdline_parser_params_init(params);  
  return params;
}
...
int
mwc_cmdline_parser_dump(FILE *outfile, struct mwc_args_info *args_info)
{
  int i = 0;

  if (!outfile)
    {
      fprintf (stderr, "%s: cannot dump options to stream\n", MWC_CMDLINE_PARSER_PACKAGE);
      return EXIT_FAILURE;
    }
  ...
  if (args_info->characters_given)
    write_into_file(outfile, "characters", 0, 0 );
...
int
mwc_cmdline_parser_file_save(const char *filename, struct mwc_args_info *args_info)
{
  FILE *outfile;
  int i = 0;
  ...
  if (!outfile)
    {
      fprintf (stderr, "%s: cannot open file for writing: %s\n", MWC_CMDLINE_PARSER_PACKAGE, filename);
      return EXIT_FAILURE;
    }

  i = mwc_cmdline_parser_dump(outfile, args_info);
  fclose (outfile);
...
void
mwc_cmdline_parser_free (struct mwc_args_info *args_info)
{
  mwc_cmdline_parser_release (args_info);
}
...
int
mwc_cmdline_parser (int argc, char **argv, struct mwc_args_info *args_info)
{
  return mwc_cmdline_parser2 (argc, argv, args_info, 0, 1, 1);
}

int
mwc_cmdline_parser_ext (int argc, char **argv, struct mwc_args_info *args_info,
                   struct mwc_cmdline_parser_params *params)
{
  int result;
  result = mwc_cmdline_parser_internal (argc, argv, args_info, params, 0);
...
int
mwc_cmdline_parser2 (int argc, char **argv, struct mwc_args_info *args_info, int override, int initialize, int check_required)
{
  int result;
  struct mwc_cmdline_parser_params params;
...
int
mwc_cmdline_parser_required (struct mwc_args_info *args_info, const char *prog_name)
{
  FIX_UNUSED (args_info);
 ...
 * @param check_ambiguity @see mwc_cmdline_parser_params.check_ambiguity
 * @param override @see mwc_cmdline_parser_params.override
...
int update_arg(void *field, char **orig_field,
               ...
               mwc_cmdline_parser_arg_type arg_type,
...
int
mwc_cmdline_parser_internal (
  int argc, char **argv, struct mwc_args_info *args_info,
                        struct mwc_cmdline_parser_params *params, const char *additional_error)
{
  int c;	/* Character of the parsed option.  */

  int error_occurred = 0;
  struct mwc_args_info local_args_info;
  ...
  if (initialize)
    mwc_cmdline_parser_init (args_info);

  mwc_cmdline_parser_init (&local_args_info);
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'h':	/* Print help and exit.  */
          ...
          mwc_cmdline_parser_free (&local_args_info);
          exit (EXIT_SUCCESS);
        ...
        case 'c':	/* Count the number of bytes in each input file, and write it to standard output..  */
        
        
          if (update_arg((void *)&(args_info->characters_flag), 0, &(args_info->characters_given),
              &(local_args_info.characters_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "characters", 'c',
              additional_error))
            goto failure;
        
          break;
        case 'l':	/* Count the number of lines in each input file, and write it to standard output..  */
        
        
          if (update_arg((void *)&(args_info->lines_flag), 0, &(args_info->lines_given),
              &(local_args_info.lines_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "lines", 'l',
              additional_error))
            goto failure;
        
          break;
        case 'w':	/* Count the number of words in each input file, and write it to standard output..  */
        ...
        default:	/* bug: option not considered.  */
          fprintf (stderr, "%s: option unknown: %c%s\n", MWC_CMDLINE_PARSER_PACKAGE, c, (additional_error ? additional_error : ""));
          abort ();
        } /* switch */
    } /* while */
  ...
  mwc_cmdline_parser_release (&local_args_info);
